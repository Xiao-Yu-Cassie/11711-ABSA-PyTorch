...
class ABSADataset(Dataset):
    def __init__(self, fname, tokenizer, balance_neutral=False):
        ...
        for i in range(0, len(lines), 3):
            ...
            if tokenizer.tok_type == "bertweet":
                ...
                concat_bert_indices = tokenizer.text_to_sequence('<s> ' + text_left + " " + aspect + " " + text_right + ' </s> ' + aspect + " </s>")
